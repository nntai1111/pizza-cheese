...
public class AuthController {
    ...
    @Operation(
            ...
            description = "Gửi application/json khi không upload avatar. Dùng endpoint multipart nếu cần upload file avatar.")
    @PostMapping(value = "/register", consumes = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<RestResponse<LoginResponse>> registerJson(@Valid @RequestBody RegisterRequest request) {
    ...
    public ResponseEntity<RestResponse<LoginResponse>> registerMultipart(
        ...
        LoginResponse loginResponse = authService.register(request, avatar);
        return ResponseEntity.ok(RestResponse.success(loginResponse));
    }
